...
class KpiChatRequestSerializer(serializers.Serializer):
    message = serializers.CharField(allow_blank=False, trim_whitespace=True, max_length=8000)


class KpiChatResponseSerializer(serializers.Serializer):
    html_response = serializers.CharField()


class KpiUploadRequestSerializer(serializers.Serializer):
...
class KpiUploadResponseSerializer(serializers.Serializer):
    html_response = serializers.CharField()
